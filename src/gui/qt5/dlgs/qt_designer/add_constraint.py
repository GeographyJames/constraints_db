...
class Ui_AddConstraintDlg(object):
    ...
    def retranslateUi(self, AddConstraintDlg):
        ...
        self.LayerNameLE.setToolTip(_translate("AddConstraintDlg", "Convention is to begin name with administrative area abbreviation."))
        self.LayerNameLE.setPlaceholderText(_translate("AddConstraintDlg", "suggested name autogenerated from selections"))
