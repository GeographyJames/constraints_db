...
class Ui_AddConstraintDlg(object):
    def setupUi(self, AddConstraintDlg):
        ...
        self.gridLayout.addWidget(self.ExpiresCB, 16, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.LastUpdatedCB, 14, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.SourceLE, 12, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.NextUpdateCB, 15, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.UpdateCycleLE, 13, 1, 1, 2)
        self.LicenseCB = QtWidgets.QComboBox(AddConstraintDlg)
        self.LicenseCB.setObjectName("LicenseCB")
        self.gridLayout.addWidget(self.LicenseCB, 11, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.AddLicensePB, 11, 2, 1, 1)
        self.LayerNameLE = QtWidgets.QLineEdit(AddConstraintDlg)
        self.LayerNameLE.setToolTip("")
        self.LayerNameLE.setReadOnly(False)
        ...
        self.gridLayout.addWidget(self.NotesTE, 17, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.LastUpdatedDE, 14, 1, 1, 1)
